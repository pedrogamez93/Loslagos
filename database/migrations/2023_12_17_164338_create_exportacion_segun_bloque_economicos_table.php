...
class CreateExportacionSegunBloqueEconomicosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ExportacionSegunBloqueEconomico', function (Blueprint $table) {
            $table->id();
            $table->timestamps();
            $table->string('titulo');
    ...
    {
        Schema::dropIfExists('ExportacionSegunBloqueEconomico');
    }
}
