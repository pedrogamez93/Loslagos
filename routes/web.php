...
Route::get('/funcionarios/edit2', [FuncionarioController::class, 'edit2'])->name('funcionarios2.edit');
// Route::middleware(['auth', 'role:admin,editor'])->group(function () {
    ...
    Route::put('/funcionariosupdate/{id}', [FuncionarioController::class, 'update'])->name('funcionarios.update')->middleware('auth');
...
Route::get('/biblioteca/download/{id}', [BibliotecaController::class, 'downloadbiblio'])->name('biblioteca.download');
...
Route::get('presentaciones/download/{id}', [PresentacionesController::class, 'downloadpresen'])->name('presentaciones.download');
