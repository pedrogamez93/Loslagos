...
class ConsejerosOsornoController extends Controller
{
    public function index(){
        $consejeros = ConsejerosOsorno::all();
        return view('consejerososorno.index', compact('consejeros'));
    }

    public function create()
    {
        return view('consejerososorno.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $consejero = ConsejerosOsorno::create([
        ...
        return redirect()->route('consejerososorno.index', ['consejero' => $consejero->id]);
        }

        public function edit($id)
        {
            $consejero = ConsejerosOsorno::findOrFail($id);
            return view('consejerososorno.edit', compact('consejero'));
        }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('consejerososorno.index');
    }

    public function show($id){
        $consejero = ConsejerosOsorno::findOrFail($id);
        return view('consejerososorno.show', compact('consejero'));
    }
}
