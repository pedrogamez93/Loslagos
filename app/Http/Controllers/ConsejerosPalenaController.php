...
class ConsejerosPalenaController extends Controller
{
    public function index(){
        $consejeros = ConsejerosPalena::all();
        return view('consejerospalena.index', compact('consejeros'));
    }

    public function create()
    {
        return view('consejerospalena.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $consejero = ConsejerosPalena::create([
        ...
        return redirect()->route('consejerospalena.index', ['consejero' => $consejero->id]);
        }

        public function edit($id)
        {
            $consejero = ConsejerosPalena::findOrFail($id);
            return view('consejerospalena.edit', compact('consejero'));
        }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('consejerospalena.index');
    }

    public function show($id){
        $consejero = ConsejerosPalena::findOrFail($id);
        return view('consejerospalena.show', compact('consejero'));
    }
}
