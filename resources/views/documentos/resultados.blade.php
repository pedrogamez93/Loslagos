...
<div id="banner" class="h-500 text-light colorB" style="height: 502px; display: flex; flex-wrap: wrap; align-content: center; align-items: center; padding-left: 50px;">
    <div class="container">
...
<div class="contenido colorB" style="margin-top: -7vh; background-color: white; border-top-left-radius: 80px;">
    ...
    <div style="padding-right: 10rem!important; padding-left: 10rem!important;">
        ...
        @else
            <table class="table">
                ...
                <tbody>
                    @foreach($resultados as $documento2)
                        <tr>
