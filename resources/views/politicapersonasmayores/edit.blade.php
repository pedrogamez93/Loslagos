            ...
            <div class="container principal mt-4 mb-4 pt-3 pb-3">
                ...
                <div class="container first-form pt-2 pb-2">
                    ...
                    <form action="{{ route('politicapersonasmayores.update', $ultimoRegistro->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <textarea class="form-control mt-2 mb-4" id="editor" name="bajada" placeholder="Bajada o Descripción">{{ $ultimoRegistro->bajada }}</textarea>
  ...
  tinymce.init({
    ...
    setup: function (editor) {
        editor.on('init', function () {
            editor.setMode('readonly'); // Iniciar como solo lectura
        });
    }
  });
</script>
...
<script>
    $(document).ready(function() {
        ...
        $("#editar").click(function() {
            ...
            tinymce.get('editor').setMode('design'); // Habilitar TinyMCE para editar
        });
    });
</script>
</body>
