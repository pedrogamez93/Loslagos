            ...
            <div class="row">
                ...
                <div class="col-md-4" style="border-left: 2px solid #F59120;">
                    <p class="title-categ pb-4">Categorias Asamblea Climática</p>
                        <p class="mistyle-final-pcateg mt-2 mb-2"><a href="/gobiernoregional/asambleaclimatica">Asamblea Climática Ciudadana</a></p>
                        <p class="mistyle-final-pcategoff mt-2 mb-2"><a href="">Audiencias de Partes Interesadas</a></p>
                </div>
            </div>
        </div>    
    </main>
