    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="container principal pt-3 pb-3">
                <div class="row">
                    <div class="col-md-12">
                        <h1>Registro de Política Regional Turismo</h1>
                    </div>
                </div>
                <div class="container first-form pt-2 pb-2">

                <form action="{{ route('PoliticaRegionalTurismo.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf 
                                ...
                                <div class="row">
                                    <div class="documentos-container col-md-12 mt-3">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="input-group mb-3">
                                                    <input type="file" id="hombres" name="url" class="form-control" placeholder="Cargar archivo" required>
                                                </div>
                                            </div>
                                        </div>
                                        </div>
