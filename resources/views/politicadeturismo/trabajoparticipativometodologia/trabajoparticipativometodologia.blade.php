                        ...
                        <div class="col-md-8">
                            <div class="container int">
                                <div class="row">
                                    ...
                                    <div class="container int">
                                        <div class="row">
                                            <div class="col-md-10 mt-4 bordertpmi p-4">
                                                <div class="container int">
                                                    <div class="row">
                                                       
                                                        @foreach ($principal->TrabajoParticipativoMetodologiaI as $secundario)
                                                        ...
                                                        <div class="col-md-6 p-3">
                                                            ...
                                                            <a href="{{ route('TrabajoParticipativoMetodologia.download', ['id' => $secundario->id]) }}">{{ $secundario->nombreA }}</a>
                                                            </div>        
                                                        </div> 
                                                            </div>        
                                                        </div>        
