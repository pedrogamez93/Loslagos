...
<style>
    ...
    .bordertpmi{ border: 1px solid #F59120;}
    .bordertpmiB {
        border-bottom: 1px solid #F59120;
        text-align: center;
        font-family: "Inter";
        font-size: 20px;
        font-weight: 700;
                        ...
                        <div class="col-md-8">
                            <div class="container int">
                                <div class="row">
                                    ...
                                    <h2 class="title-cat mb-4">{{ $principal->nombre }}</h2>
                                    <div><p>{!! $principal->descripcion ?? '' !!}</div>
                                    <div class="container int">
                                        <div class="row">
                                            <div class="col-md-10 mt-4 bordertpmi p-0">
                                            <div class="col-md-12 mt-0 bordertpmiB ">
                                                {{ $principal->tituloA }}
                                            </div>
                                                <div class="container int">
                                                    <div class="row">
                                                       
                                                        @foreach ($principal->TrabajoParticipativoTalleresProvincialesI as $secundario)
                                                        ...
                                                        <div class="col-md-6 p-3">
                                                            ...
                                                            <a href="{{ route('TrabajoParticipativoTalleresProvinciales.download', ['id' => $secundario->id]) }}">{{ $secundario->nombreA }}</a>
                                                            </div>        
                                                        </div> 
                                                            </div>        
                                                        </div>        
