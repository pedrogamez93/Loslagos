    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="container principal pt-3 pb-3">
                <div class="row">
                    <div class="col-md-12">
                        <h1>Registro de Talleres Provinciales</h1>
                    </div>
                </div>
                <div class="container first-form pt-2 pb-2">

                <form action="{{ route('TrabajoParticipativoTalleresProvinciales.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf 
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12 title">
                                        <div class="input-group mb-3">
                                            <input type="text" id="titulo" name="tituloA" class="form-control" placeholder="Titulo de Asistencia" required>
                                        </div>
                                    </div>
