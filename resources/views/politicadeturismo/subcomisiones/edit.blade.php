    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="container principal mt-4 mb-4 pt-3 pb-3">
                <div class="row">
                    <div class="col-md-12">
                        <h1>Actualizar de Subcomisiones</h1>
                    </div>
                </div>
                <div class="container first-form pt-2 pb-2">

                <form action="{{ route('Subcomisiones.update', $articulo->id) }}" method="POST" enctype="multipart/form-data">
                @method('PUT')        
                @csrf
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                        ...
                                        @foreach ($items as $item)
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group mb-3">
                                                    <a href="{{ route('Subcomisiones.download', ['id' => $item->id]) }}">Ver Documento</a>
                                                    </div>
                                                </div>
                                                <div class="col-md-12 pt-3 pb-3" style="text-align: end;">
                                                    <a href="{{ route('Subcomisiones.destroy', $item->id) }}" class="btn btn-danger agregar-documento" id="agregarCampo">Eliminar</a>
                                                </div>
                                        @endforeach
                                        </div>
                                    </div>
