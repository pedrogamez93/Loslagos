        ...
        <div class="col-md-10">
            <div class="container principal mt-4 mb-4 pt-3 pb-3">
                ...
                <div class="container first-form pt-2 pb-2">
                    ...
                    <form id="formulario-creacion" action="{{ route('difusion.update', $difusion->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-md-12 title">
                                    <div class="input-group mb-3">
                                        <input type="text" id="titulo" name="titulo" class="form-control" placeholder="Titulo seccion" value="{{ $difusion->titulo }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12 pb-3">
                                <div id="text">
                                    <div class="form-floating">
                                        <textarea name="bajada" id="editor" class="form-control" placeholder="Escribe tu contenido aquí" id="bajada" style="height: 250px">{!! $difusion->bajada !!}</textarea>           
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    @foreach($difusion->documentos as $documento)
                        <div class="documento-existente mt-4" style="display: flex; align-items: center; margin-bottom: 10px;">
                            ...
                            <form action="{{ route('difusion-docs.destroy', $documento->id) }}" method="post">
                                @csrf
                                @method('DELETE')
                ...
                <a href="{{ route('difusion.index') }}" class="btn btn-primary mt-4">Volver al Índice</a>
            </div>
        </div>
    </div>
</div>
