                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6 title">
                                    <div class="input-group mb-3">
                                        <input type="text" id="titulo" name="nombreseccion" class="form-control" placeholder="Título sección" value="{{ $Introduccion->nombreseccion }}"  required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-12 pb-3">
                                    <div id="text">
                                        <div class="form-floating">
                                            <textarea class="form-control" placeholder="Escribe tu contenido aquí" style="height: 250px"  id="editor" name="descripcion">{{ $Introduccion->descripcion }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
