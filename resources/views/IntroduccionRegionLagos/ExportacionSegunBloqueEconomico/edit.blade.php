    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="container principal pt-3 pb-3">
                <div class="row">
                    <div class="col-md-12">
                        <h1>Actualizar Exportación Según Bloque Económico</h1>
                    </div>
                </div>
                <div class="container first-form pt-2 pb-2">
                <form action="{{ route('ExportacionSegunBloqueEconomico.update', $articulo->id) }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                        @csrf
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 provincia">
                                    <div class="input-group mb-3">
                                        <input type="text" id="actividad6" name="actividad6" class="form-control" value="{{ $articulo->actividad6 }}" placeholder="Actividad 6" required>
                                    </div>
                                </div>
                                <div class="col-md-3 title">
                                    <div class="input-group mb-3">
                                    <input type="text" id="valoractividad6" name="valoractividad6" class="form-control" value="{{ $articulo->valoractividad6 }}" placeholder="Valor Actividad 6" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 provincia">
                                    <div class="input-group mb-3">
                                        <input type="text" id="total" name="total" class="form-control" placeholder="total"  value="{{ $articulo->total }}"  required>
                                    </div>
                                </div>
                            </div>
