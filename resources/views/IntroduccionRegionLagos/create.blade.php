...
<div class="container-fluid body">
    <div class="row">
        ...
        <div class="container principal mt-4 mb-4 pt-3 pb-3">
                <div class="row">
                    <div class="col-md-12">
                        <h1>Formulario de Introducción Region de los Lagos</h1>
                    </div>
                </div>
                <div class="container first-form pt-2 pb-2">

                    <form id="formulario-edicion" action="{{ route('IntroduccionRegionLagos.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6 tag-comentario">
                                    <div class="input-group mb-3">
                                        <input type="text" id="tag_comentario" name="subtitulo" class="form-control" placeholder="Tag o comentario" value="" >
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 pb-3">
                                    <div id="text">
                                        <div class="form-floating">
                                            <textarea name="descripcion" class="form-control" placeholder="Escribe tu contenido aquí" id="bajada" style="height: 250px" ></textarea>
