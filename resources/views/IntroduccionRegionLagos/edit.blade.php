    ...
    <div class="row">
        ...
        <div class="container principal mt-4 mb-4 pt-3 pb-3">
                ...
                <div class="container first-form pt-2 pb-2">
                    ...
                    <form action="{{ route('IntroduccionRegionLagos.update', $articulo->id) }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                        @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6 tag-comentario">
                                    <div class="input-group mb-3">
                                        <input type="text" id="tag_comentario" name="subtitulo" class="form-control" placeholder="Tag o comentario" value="{{ $articulo->subtitulo }}" required>
                                    </div>
                                </div>
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-md-12 pb-3">
                        <div id="text">
                            <div class="form-floating">
                                <textarea name="descripcion" class="form-control" placeholder="Escribe tu contenido aquí" id="bajada" style="height: 250px" required>{{ $articulo->descripcion }}</textarea>
                                <label class="style-label" for="floatingTextarea2 style-label">Bajada de la introducción</label>
                            </div>
                        </div>
                    </div>
