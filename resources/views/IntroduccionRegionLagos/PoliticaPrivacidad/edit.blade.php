    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="container principal pt-3 pb-3">
                <div class="row">
                    <div class="col-md-12">
                        <h1>Actualizar Políticas de Privacidad</h1>
                    </div>
                </div>
                <div class="container first-form pt-2 pb-2">

                <form action="{{ route('PoliticaPrivacidad.update', $articulo->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                            <div class="row">
                                <div class="col-md-12 tag-comentario">
                                    <div class=" mb-3">
                                    <textarea class="form-control" placeholder="Escribe tu contenido aquí" style="height: 250px"  id="editor" name="descripcionG1">{{ $articulo->descripcionG1 }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                <div class="row">
