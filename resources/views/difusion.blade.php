            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="container pt-5 pb-5">
                        <div class="row" >
                            <div class="col-md-12" >
                            <p class="style-bread"><a href="http://127.0.0.1:8000/">Home </a>/<a href=""></a><span style="font-Weight: 700;"><a href="/agenda">Difusión</a></span></p>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 p-0">
                                    <div class="container int p-0">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <p class="title-cat">{{ $difusion->titulo }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="col-md-4 borderM d-block d-lg-none">
                                            ...
                                            <div class="col-md-8" style="text-align: justify;">
                                               ...
                                               <p class="style-cont style-down mb-5">{!! $difusion->bajada ?? '' !!}</p>
                                                ...
                                                @if ($difusion->documentos->count() > 0)
                                                    <div class="migrid mt-5" style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1rem; border: 1px solid #F59120; padding: 20px;">
                                                        @foreach ($difusion->documentos as $documento)
                                                            <a href="{{ route('difusion.download', $documento->id) }}" target="_blank" style="display: flex; align-items: center; text-align: left;">
