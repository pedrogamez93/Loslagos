            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="container pt-5 pb-5">
                        <div class="row" >
                            <div class="col-md-12" >
                            <p class="style-bread"><a href="http://127.0.0.1:8000/">Home </a>/<a href=""></a><span style="font-Weight: 700;"><a href="">Seminario Internacional de Turismo</a></span></p>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 p-0">
                                    <div class="container int p-0">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <p class="title-cat">{{ $lastRegistro->titulo }}</p>
                                            </div>
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="galerias-grid">
                                                            @forelse($galerias as $galeria)
                                                                ...
                                                                <a href="{{ route('seminarios.show', $galeria->id) }}" class="galeria-link">
                                                                    <div class="galeria-item" style="background-image: url('{{ $imagenSeminario ? route('seminario.imagen.mostrar', ['filename' => basename($imagenSeminario->archivo)]) : asset('storage/images/default.jpg') }}');">
