            ...
            <div class="container principal mt-4 mb-4 pt-3 pb-3">
                ...
                <div class="container first-form pt-2 pb-2">
                    ...
                    <form action="{{ route('sitiodegobierno.update', ['id' => $sitiodegobierno->id]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <input class="form-control mt-2" type="text" name="titulo" value="{{ $sitiodegobierno->titulo }}" placeholder="Título" required>
                       
                        <!-- <select class="form-select mt-4" aria-label="Default select example" name="categoria">
                            <option selected>{{ $sitiodegobierno->categoria }}</option>
                        ...
                        <div class="mb-3 mt-4">
                            ...
                            <textarea class="form-control" name="descripcion" id="descripcion">{{ $sitiodegobierno->descripcion }}</textarea>
                        </div>
                        ...
                        <div class="mb-3 mt-4">
                            ...
                            @if($sitiodegobierno->archivo_path)
                                <div class="mt-2">
                                    <p>Archivo actual: <a href="{{ route('imagen.mostrar', ['imagen' => $sitiodegobierno->archivo_path]) }}" target="_blank">Ver archivo</a></p>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="mb-3 mt-4">
                            ...
                            <input class="form-control" type="date" name="fecha" id="formDate" value="{{ $sitiodegobierno->fecha }}">
                        </div>
