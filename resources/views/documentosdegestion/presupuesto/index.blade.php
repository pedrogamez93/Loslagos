                    ...
                    <div class="container second content-breadc pt-5 pb-5">
                        <div class="row" style="padding: 10px 0px 20px 55px;">
                            <div class="col-md-12" style="padding: 0;">
                                <p class="style-bread"><a href="http://127.0.0.1:8000/">Home </a>/<a href="/gobiernoregional/acerca"> Gobierno Regional</a> / <a href ="/documentosdegestion">Documentos de Gestion</a> / <a style="font-Weight: 700;" href ="/documentosdegestion">Presupuesto</a></p>
                            </div>
                        </div>
                                                ...
                                                <div class="accordion-item">
                                                    <h2 class="accordion-header" id="heading{{ $accordionId }}">
                                                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse{{ $accordionId }}" aria-expanded="{{ $anio == $anioActual ? 'true' : 'false' }}" aria-controls="collapse{{ $accordionId }}">
                                                            <p class="title-acord-one">Presupuesto {{ $anio }}</p>
                                                        </button>
                                                    </h2>
