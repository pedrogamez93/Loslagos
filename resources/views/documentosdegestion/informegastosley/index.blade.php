                    ...
                    <div class="container second content-breadc pt-5 pb-5">
                        <div class="row" style="padding: 10px 0px 20px 55px;">
                            <div class="col-md-12" style="padding: 0;">
                                <p class="style-bread"><a href="http://127.0.0.1:8000/">Home </a>/<a href="/gobiernoregional/acerca"> Gobierno Regional</a> / <a href ="/documentosdegestion">Documentos de Gestion</a> / <a style="font-Weight: 700;" href ="/documentosdegestion">Informe Gastos Ley 21.516</a></p>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="container content mt-5 mb-5">
                            <div class="row">
                                <div class="col-md-8">
                                    <h1 class="mititulo">Cuenta Pública Informe de gastos y programación Programa 01 y 02 Ley de Presupuesto 21.516 del 20/12/2022, artículo 14</h1>
                                <div class="container">
                                                ...
                                                <div class="accordion-item">
                                                    <h2 class="accordion-header" id="heading{{ $accordionId }}">
                                                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse{{ $accordionId }}" aria-expanded="{{ $anio == $anioActual ? 'true' : 'false' }}" aria-controls="collapse{{ $accordionId }}">
                                                            <p class="title-acord-one">Glosa {{ $anio }}</p> <!-- Ajusta el título según sea necesario -->
                                                        </button>
                                                    </h2>
