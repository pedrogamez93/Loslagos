                    ...
                    <div class="container second content-breadc pt-5 pb-5">
                        <div class="row">
                            <div class="col-md-12 p-0">
                                <p class="style-bread"><a href="http://127.0.0.1:8000/">Home </a>/<a href="/gobiernoregional/acerca"> Gobierno Regional</a> / <a style="font-Weight: 700;" href ="/documentosdegestion">Documentos de Gestion</a></p>
                            </div>
                        </div>
                                                                ...
                                                                @foreach ($documentos as $documento)
                                                                    <div class="col-md-6">
                                                                        <div class="mi-documento mt-3 mb-3 d-flex align-items-center">
                                                                            <a href="{{ route('documentos.download', $documento->id) }}" target="_blank" class="d-flex align-items-center text-decoration-none">
