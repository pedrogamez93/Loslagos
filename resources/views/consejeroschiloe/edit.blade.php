    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="container principal mt-4 mb-4 pt-3 pb-3">
                <div class="row">
                    <div class="col-md-12">
                        <h1>Información Consejero de chiloe</h1>
                    </div>
                </div>
                <div class="container first-form pt-2 pb-2">
                    <div class="row">
                        <div class="col-md-12">
                            <h2>Información Consejero de chiloe</h2>
                        </div>
                    </div>

                    <!-- Mostrar los valores del id del registro seleccionado -->
                    <form action="{{ route('consejeroschiloe.update', ['consejeroschiloe' => $consejero->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                ...
                @if ($consejero)
                <form action="{{ route('consejeroschiloe.destroy', $consejero->id) }}" method="POST">
                @csrf
                @method('DELETE')
                ...
                <div class="btn-final" style="text-align: -webkit-center; padding-top: 0.5rem;font-weight: 700 !important;">
                    <a class="milastbtn" href="{{ route('consejeroschiloe.index') }}" style="font-weight: 700 !important;">Volver</a>
                </div>
            </div>
        </div>
    </div>
