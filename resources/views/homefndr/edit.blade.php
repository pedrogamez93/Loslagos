        ...
        <div class="col-md-10">
            <div class="container principal mt-4 mb-4 pt-3 pb-3">
                ...
                <div class="container first-form pt-2 pb-2">
                    ...
                    <form action="{{ route('homefndr.update', $homefndr->id) }}" method="POST">                        @csrf
                        @method('PUT')
                            <!-- Campos del formulario -->
                            <label class="style-label required" for="titulo">Título:</label>
                            <input class="form-control mt-2" type="text" name="titulo" value="{{ $homefndr->titulo }}">

                            <label class="style-label required" for="bajada">bajada:</label>
                            <input class="form-control mt-2" type="text" name="bajada" value="{{ $homefndr->bajada }}">
                           
                            <label class="style-label" for="descripcion">Descripción:</label>
                            <textarea class="form-control mt-2 mb-4" id="editor" name="descripcion">{{ $homefndr->descripcion }}</textarea>
