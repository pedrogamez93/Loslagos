...
<style>
    ...
    li.session-item {
        margin-bottom: 15px; /* Espacio entre los elementos <li> */
    }
</style>
                                ...
                                <ul>
                                    @foreach($sesiones as $sesion)
                                        <li class="session-item">
                                            ...
                                            <form action="{{ route('sesionesConsejo.destroy', $sesion->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('¿Estás seguro de que deseas eliminar esta tabla de sesión con todo su contenido?');">
                                                @csrf
                                                @method('DELETE')
