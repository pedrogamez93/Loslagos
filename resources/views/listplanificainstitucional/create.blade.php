    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="container principal pt-3 pb-3">
                ...
                <form action="{{ route('listplanificainstitucional.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf 
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6 title">
                                    ...
                                    <input class="form-control" type="file" name="urldocs" id="file" accept="pdf">
                                </div>
                            </div>
