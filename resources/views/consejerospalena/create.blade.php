    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="container principal mt-4 mb-4 pt-3 pb-3">
                    <div class="row">
                        <div class="col-md-12">
                            <h1>Formulario para la creacion de los consejeros de Palena</h1>
                        </div>
                    </div>
                    <div class="container first-form pt-2 pb-2">
                        ...
                        <form id="formulario-creacion" action="{{ route('consejerospalena.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                    ...
                    <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <a href="{{ route('consejerospalena.index') }}" class="btn btn-success mt-3 mb-3" style="width: 250px;">Volver</a>
                                </div>
                            </div>
                        </div>
               </div>
