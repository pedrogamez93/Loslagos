        ...
        <div class="col-md-10">
            <div class="container principal mt-4 mb-4 pt-3 pb-3">
                ...
                <div class="container first-form pt-2 pb-2">
                    ...
                    <form action="{{ route('nombre.ruta.actualizar.seccion', $seccion->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6 title">
                                    <div class="input-group mb-3">
                                        <input type="text" id="titulo" name="titulo_seccion" class="form-control" placeholder="Titulo seccion" value="{{ $seccion->titulo_seccion }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12 pb-3">
                                    <div id="text">
                                        <div class="form-floating">
                                            <textarea name="bajada_seccion" class="form-control" placeholder="Escribe tu contenido aquí" id="bajada" style="height: 250px">{{ $seccion->bajada_seccion }}</textarea>
                            ...
                            <div class="form-group">
                                <div class="col-md-12 pt-3 pb-3">
                                    ...
                                    <input class="form-control" type="file" name="img_seccion" id="img" accept="image/*">
                                </div>
                            </div>
                        </div>
