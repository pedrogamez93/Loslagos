...
<div class="container-fluid body">
    <div class="row">
        ...
        <div class="container principal mt-4 mb-4 pt-3 pb-3">
                <div class="row">
                    <div class="col-md-12">
                        <h1>Creacion de Seminario Internacional de Turismo</h1>
                    </div>
                </div>
                <div class="container first-form pt-2 pb-2">
                    ...
                    @endif
                    <!-- Formulario para la creación de un nuevo -->
                    <form action="{{ route('seminarios.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf

                        <!-- Campos para el título y la descripción del seminario -->
                        ...
                        <textarea class="form-control mt-2 mt-5" id="editor" name="bajada" placeholder="Bajada o Descripción"></textarea>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <button class="mt-5 btn btn-success" type="submit">Guardar seminario</button>
                            </div>
                        </div>
                    </form>
                </div>
