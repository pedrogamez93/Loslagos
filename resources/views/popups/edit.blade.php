...
<div class="container-fluid body">
    <div class="row">
        ...
        <div class="container principal mt-4 mb-4 pt-3 pb-3">
                <div class="row">
                    <div class="col-md-12">
                        <h1>Formulario para editar el Popups</h1>
                    </div>
                </div>
                <div class="container first-form pt-2 pb-2">
                    <div class="col-md-12 pb-2" style=" text-align: end; ">
                        <form method="POST" action="{{ route('popups.update', $articulo->id) }}" style="display: inline;">
                            @method('DELETE')
                            @csrf
                            <button type="submit" class="btn btn-danger">Eliminar Popups</button>
                        </form>
                    </div>
                    <form action="{{ route('popups.update', $articulo->id) }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                        @csrf
                            ...
                            <div class="row">
                                <div class="col-md-12 title">
                                    <div class="input-group mb-3">
                                        <input type="text" id="titulo" name="title" class="form-control" placeholder="Título sección"  value="{{ $articulo->title }}" >
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12 pb-3">
                                    <div id="text">
                                        <div class="form-floating">
                                            <textarea class="form-control" placeholder="Escribe tu contenido aquí" style="height: 250px"  id="editor" name="description">{{ $articulo->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-12 tag-comentario">
                                <div class="input-group mb-3">
                                    <input type="text" id="url" name="url" class="form-control" placeholder="Url" value="{{ $articulo->url }}" >
                                </div>
                            </div>
                                ...
                                <div class="col-md-6 pt-3 pb-3">
                                    ...
                                    <div class="col-md-12 pb-3">
                                        ...
                                        <img src="{{ asset($articulo->image_url) }}" alt="Imagen Actual" width="250">
                                    </div>
                                </div>
                            </div>
                        </div>
