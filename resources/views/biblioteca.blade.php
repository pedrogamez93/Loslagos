            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="container pt-5 pb-5">
                        <div class="row" >
                            <div class="col-md-12" >
                            <p class="style-bread"><a href="http://127.0.0.1:8000/">Home </a>/<a href=""></a><span style="font-Weight: 700;"><a href="/agenda">Biblioteca</a></span></p>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 p-0">
                                    <div class="container int p-0">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <p class="title-cat">Biblioteca</p>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md-8">
                                                <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1rem; border: 1px solid #F59120; border-radius: 5px; padding: 20px;">
                                                    @foreach ($biblioteca as $arti)
                                                        <a href="{{ route('download.biblioteca', $arti->id) }}" target="_blank" style="display: flex; align-items: center; text-align: left;">
                                                            <img width="43px" height="44px" src="{{ asset('storage/images/pdf.png') }}" alt="Descripción de la imagen" style="margin-right: 10px;">    
                                                            <span class="mi-span">{{ $arti->titulo }}</span>
                                                        </a>
                                                    @endforeach
                                                </div>
                                            </div>
