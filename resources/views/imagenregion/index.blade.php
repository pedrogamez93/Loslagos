            ...
            <div class="container principal mt-4 mb-4 pt-3 pb-3">
                ...
                <div class="container first-form pt-2 pb-2">
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12 title">
                                    <div class="input-group mb-3">
                                        <input type="text" id="titulo" name="titulo" class="form-control" placeholder="Titulo seccion" value="{{ $imagenregion->titulo }}" disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12 pb-3">
                                <div id="text">
                                    <div class="form-floating">
                                        <textarea name="bajada" class="form-control" placeholder="Escribe tu contenido aquí" id="editor" style="height: 250px" disabled>{!! $imagenregion->bajada !!}</textarea>
                        ...
                        <button type="button" onclick="location.href='{{ route('imagenregion.edit', $imagenregion->id) }}'" class="btn btn-primary">Editar</button>
                </div>
            </div>
        </div>
    </div>
