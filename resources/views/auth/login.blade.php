    ...
    <div class="row">
        <div class="col-md-12">
            <div class="container pt-5 pb-5">
                <div class="row" >
                    <div class="col-md-12" >
                        <p class="style-bread"><a href="/">Home </a> / <span style="font-Weight: 700;"><a href="#">Login</a></span></p>                    </div>
                    </div>
                    <div class="col-md-12 pt-5 pb-5">
                        <p class="one-title pb-4">Acceso administrador</p>
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                       ...
                       <h2 class="Iniciar_Accede">Iniciar / Accede</h2>
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <label for="email" class="col-md-12 col-form-label labelI">{{ __('Email') }}</label>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <label for="password" class="col-md-12 col-form-label labelI">{{ __('Contraseña') }}</label>
