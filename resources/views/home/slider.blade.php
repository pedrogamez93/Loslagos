...
<div class="container-fluid body">
    <div class="row">
        ...
        <div class="container principal mt-4 mb-4 pt-3 pb-3">
                <div class="row">
                    <div class="col-md-12">
                        <h1>Formulario de edicion sliders</h1>
                        @if(session('success'))
                ...
                <div class="container first-form pt-2 pb-2">
                    ...
                    <form action="{{ url('/home/updateslider') }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
        ...
        @if($home->$slider)
            <div class="mb-3 mt-4">
                ...
                <img src="{{ route('mostrar.imagen', ['carpeta' => 'sliders', 'imagen' => basename($home->$slider)]) }}" class="img-fluid imagen-con-brillo mx-5"  id="currentImage{{ $i }}" style="max-width: 200px; max-height: 200px;">
            </div>
        @endif

        <div class="mb-3 mt-4">
            <label for="formFile" class="form-label">Slider {{ $i }}</label>
            <input class="form-control" type="file" name="slider{{ $i }}" id="slider{{ $i }}" onchange="previewAndReplaceImage(this, 'currentImage{{ $i }}')">
