            ...
            <div class="container second content-breadc pt-5 pb-5">
                <div class="row" style="padding: 10px 0px 20px 55px;">
                    <div class="col-md-12" style="padding: 0;">
                        <p class="style-bread"><a href="http://127.0.0.1:8000/">Home </a>/<a href="/gobiernoregional/acerca"> Gobierno Regional</a>/<a href="/gobiernoregional/acerca"> Acerca</a> / <span style="font-Weight: 700;"><a href="/gobiernoregional/acerca/comofunciona">Cómo Funciona</a></span></p>
                    </div>
                </div>
                            ...
                            <div class="container img">
                                <div class="row">
                                    <div class="col-md-12" style="text-align: -webkit-center;">
                                        <img src="{{ asset($comofunciona->img) }}" alt="Imagen actual" style="max-width: 499px; max-height: 567px;">    
                                    </div>
                                </div>
                            </div>
