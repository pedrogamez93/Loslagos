    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="container principal mt-4 mb-4 pt-3 pb-3">
                <div class="row">
                    <div class="col-md-12">
                        <h1>Información Consejero de Llanquihue</h1>
                    </div>
                </div>
                <div class="container first-form pt-2 pb-2">
                    <div class="row">
                        <div class="col-md-12">
                            <h2>Información Consejero de Llanquihue</h2>
                        </div>
                    </div>

                    <!-- Mostrar los valores del id del registro seleccionado -->
                    <form action="{{ route('consejerosllanquihue.update', ['consejerosllanquihue' => $consejero->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                ...
                @if ($consejero)
                <form action="{{ route('consejerosllanquihue.destroy', $consejero->id) }}" method="POST">
                @csrf
                @method('DELETE')
