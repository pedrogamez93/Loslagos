                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 actividad">
                                        <div class="input-group mb-3">
                                            <input type="text" id="actividad" name="actividad" class="form-control" placeholder="Actividad" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 periodosenconcejo">
                                        <div class="input-group mb-3">
                                            <input type="text" id="periodosenconcejo" name="periodosenconcejo" class="form-control" placeholder="Periodos en concejo" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6 comisiones">
                                        <div class="input-group mb-3">
                                            <input type="text" id="comisiones" name="comisiones" class="form-control" placeholder="Comisiones" required>
                                        </div>
                                    </div>
