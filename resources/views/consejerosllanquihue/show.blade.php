            ...
            <div class="container second content-breadc pt-5 pb-5">
                <div class="row" style="padding: 10px 0px 20px 55px;">
                    <div class="col-md-12" style="padding: 0;">
                        <p class="style-bread"><a href="http://127.0.0.1:8000/">Home </a>/<a href="/consejoregional/introduccion"><span> Consejo Regional</span></a> /<a href="/consejoregional/presidenteconsejo"> <span style="font-Weight: 700;">Consejero de Llanquihue</span></a></p>
                    </div>
                </div>
            ...
            <div class="col-md-12 pt-5 pb-2">
                <div class="container">
                    <div class="row">
                        ...
                        <p class="style-tag">Consejero de Llanquihue...</p>
                        </div>
                    </div>
                </div>
            </div>
